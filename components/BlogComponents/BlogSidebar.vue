<template>
    <div class="blogSidebarCon">
        ...
        <div class="sectionCon">
            ...
            <div class="sectBody"> 
                <input placeholder="Search" type="text" class="inputStyle" v-model="searchQuery">
                <select class="inputStyle" v-model="categoryQuery">
                    <option value="all">Category</option>
                    <option value="website release">Website Release</option>
                    <option value="freelance">Freelane</option>
                </select>
                <button class="btnStyle1"><fa class="fas" :icon="['fas', 'search']" />Search</button>
            </div>
        </div>
        <!-- Portfolio -->
        <div class="sectionCon">
        ...
        <div class="sectionCon">
            ...
            <div class="sectBody">
                <p class="sectP">Need a website for your business or startup? Dont hesitate to get in contact!</p>
                <button class="btnStyle1"><fa class="fas" :icon="['fas', 'envelope']" />Contact</button>
            </div>
        </div>
    </div>
</template>
...
.exodiaBg {background-color: #1E63EB;}
.anyrepBg {background-color: #FA2C2C;}
.melodyBg {background-color: #EE7752;}
